...
const vcolor=['blue','orange','green'];
...
/*document.getElementById('btnsection').addEventListener('click',function(){cambiarCOLOR('blue')});
function cambiarCOLOR () 
/*btnSection.addEventListener(click,() => {
ssection.style.backgroundColor=vcolor [1]});*/
